              ...
              <div className="flex items-center">
                ...
                <div className="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
                  ...
                  <Menu as="div" className="relative ml-3">
                    ...
                    >
                      <MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-[#e1f1f5] py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        {userNavigation.map((item) => (
                          <MenuItem as={Fragment} key={item.label}>
                            {({ focus }) => (
                              <a
                                href={item.href}
                                className={classNames(
                                  focus ? "bg-[rgba(0,0,0,0.04)]" : "",
                                  "block px-4 py-2 text-sm text-[#1e5d81]",
                                )}
                              >
                                {item.label}
                              </a>
              ...
              <div className="space-y-1 px-2 sm:px-3">
                {userNavigation.map((item) => (
                  <DisclosureButton
                    ...
                    as="a"
                    href={item.href}
                    className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-[#247fca] hover:text-white"
                  >
                    {item.label}
                  </DisclosureButton>
                ))}
